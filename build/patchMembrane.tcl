...
for { set m 1 } { $m <= 1 } { incr m } {
	readpsf "solvated_and_ionized/system.psf" pdb "solvated_and_ionized/system.pdb"
	
	#pdbalias atom DOPC XYZ XY
	
	mol load psf "solvated_and_ionized/system.psf" pdb "solvated_and_ionized/system.pdb"
	...
	writepdb "solvated_and_ionized/system_patched.pdb"
	writepsf "solvated_and_ionized/system_patched.psf"
	
	mol load psf "solvated_and_ionized/system_patched.psf" pdb "solvated_and_ionized/system_patched.pdb"
	...
	$savesel writepdb "solvated_and_ionized/system_patched.pdb"
    $savesel writepsf "solvated_and_ionized/system_patched.psf"
	resetpsf
}
quit
